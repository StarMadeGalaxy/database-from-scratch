...
//                                                                              //
// USAGE: On init call: GuiLoadStyleDatabaseRayguiStyle();                             //
//                                                                              //
...
#define DATABASE_RAYGUI_STYLE_STYLE_PROPS_COUNT  16

// Custom style name: database_raygui_style
static const GuiStyleProp database_raygui_styleStyleProps[DATABASE_RAYGUI_STYLE_STYLE_PROPS_COUNT] = {
...
#define DATABASE_RAYGUI_STYLE_COMPRESSED_DATA_SIZE 964

// Font image pixels data compressed (DEFLATE)
// NOTE: Original pixel data simplified to GRAYSCALE
static unsigned char database_raygui_styleFontData[DATABASE_RAYGUI_STYLE_COMPRESSED_DATA_SIZE] = { 0xed,
...
static const Rectangle database_raygui_styleFontRecs[95] = {
    { 4, 4, 4 , 16 },
    { 16, 4, 1 , 11 },
    { 25, 4, 3 , 3 },
    { 36, 4, 6 , 11 },
...
static const GlyphInfo database_raygui_styleFontChars[95] = {
    { 32, 0, 14, 4, { 0 }},
    { 33, 1, 3, 3, { 0 }},
    { 34, 1, 3, 5, { 0 }},
    { 35, 1, 3, 8, { 0 }},
...
// Style loading function: database_raygui_style
static void GuiLoadStyleDatabaseRayguiStyle(void)
{
    // Load style properties provided
    // NOTE: Default properties are propagated
    for (int i = 0; i < DATABASE_RAYGUI_STYLE_STYLE_PROPS_COUNT; i++)
    {
        GuiSetStyle(database_raygui_styleStyleProps[i].controlId, database_raygui_styleStyleProps[i].propertyId, database_raygui_styleStyleProps[i].propertyValue);
    }

    // Custom font loading
    // NOTE: Compressed font image data (DEFLATE), it requires DecompressData() function
    int database_raygui_styleFontDataSize = 0;
    unsigned char *data = DecompressData(database_raygui_styleFontData, DATABASE_RAYGUI_STYLE_COMPRESSED_DATA_SIZE, &database_raygui_styleFontDataSize);
    ...
    memcpy(font.recs, database_raygui_styleFontRecs, font.glyphCount*sizeof(Rectangle));

    // Copy font char info data from global fontChars
    // NOTE: Required to avoid issues if trying to free font
    font.glyphs = (GlyphInfo *)malloc(font.glyphCount*sizeof(GlyphInfo));
    memcpy(font.glyphs, database_raygui_styleFontChars, font.glyphCount*sizeof(GlyphInfo));
